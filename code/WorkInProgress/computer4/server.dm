...
/obj/machinery/computer4/server
	name			= "server"
	icon			= 'icons/obj/computer3.dmi'
	icon_state		= "serverframe"
	show_keyboard	= 0

/obj/machinery/computer4/server/rack
	name = "server rack"
	icon_state = "rackframe"

	spawn_parts = list(/obj/item/part/computer4/storage/hdd,/obj/item/part/computer4/networking/radio/subspace)
